...
#C_OPT_FLAGS=-SO2 --max-allocs-per-node200000 -DNDEBUG --c-code-in-asm --std-sdcc2x --list
...
# Special rule for the levels file to make sure it picks up changes to the include
