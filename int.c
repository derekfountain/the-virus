...
/*
 * 500ms ticker. This one increments every 25 interrupts, so it
 * ticks up every 500ms.
 */
uint8_t           ticker_500ms_int_counter;  /* This goes 0-25 */
...
IM2_DEFINE_ISR(isr)
{
  ...
  if( ++ticker_500ms_int_counter == 25 )
  {
